...
class NationalController extends Controller
{
    ...
    function test()
    {
        ...
        $report_percentage_resolved = ($report_summary_resolved/$report_percentage) * 100;

        $report_percentage_new = ($report_summary_new/$report_percentage) * 100;

        $report_percentage_review = ($report_summary_review/$report_percentage) * 100;
