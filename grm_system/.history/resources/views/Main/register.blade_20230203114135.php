...
<body>
    ...
    <form class="register_successful" method="POST" action="{{ route('register_successful') }}">
        <div>
            <img src="{{ URL('img/Form_submitted.png') }}" alt="">
            <span class="register_successful_btn">
                <button class="register_successful_btn1">OK</button>
            </span>
        </div>
    </form>
