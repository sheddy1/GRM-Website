...
<body>
    ...
    <form action="" class="form" method="post">
        ...
        <div class="form_name">
            ...
            <select name="form_name_select" class="form_name_select"  id="state_select">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#state_select').on('change', function () {
                    ...
                    $('#lga_select').html('');
                    $.ajax({
                        url: '{{ route('getLgas') }}?state1='+state,
                        type: 'get';
                        success: function(res) {
                            $('#lga_select').html('<option value="">LGA</option>');
                            $.each(res, function (key, value){
                                $('#lga_Select').append('<option value="' +value.lga+ '">'+value.lgan+'</option>');
                            });
                            $('#get_wards').html('<option value="">Select City</option>')
                        }
                    });
                });
            });
        ...
        <div class="form_lga">
            ...
            <select name="form_name_select" class="form_name_select" id="lga_select">
            </select>
        </div>
