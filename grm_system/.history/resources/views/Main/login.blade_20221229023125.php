    ...
    <div class="section2">
        <div class="section2_login">
            ...
            <span class="section2_div1_password">
                <img src="{{ URL('img/padlock.png') }}" alt="background logo" class="section2_div1_email_icon" id="id_username">
                <input type="password" class="section2_div1_email_text" placeholder="Password" >
