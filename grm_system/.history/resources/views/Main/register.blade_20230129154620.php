...
<body>
    ...
    <form class="form" method= "POST" action="{{ route('homeRegister') }}">
        ...
        <div class="form_name">
            ...
            <span class="text-danger age">@error('state_selt'){{ $message }} @enderror</span>
        </div>
        ...
        <div class="form_ward">
            ...
            <select name="get_wards" class="form_name_select" id="get_wards">
        ...
        <div class="form_community">
            ...
            <select name="comm" class="form_name_select" id="comm">
        ...
        <div class="form_ben">
            ...
            <select name="ben" class="form_name_select">
        ...
        <div class="form_cname">
            ...
            <input type="text" class="form_name_select1" name="name" placeholder="NAME">
        </div>
        ...
        <div class="form_age">
            ...
            <input type="text" name="age" class="form_name_select" placeholder="AGE">
        ...
        <div class="form_cphone">
            ...
            <input type="text" name="phone" class="form_name_select1" placeholder="COMPLAINT PHONE">
        </div>
        ...
        <div class="form_cemail">
            ...
            <input type="text" name="email" class="form_name_select1" placeholder="COMPLAINT EMAIL">
        </div>
        ...
        <div class="form_desc">
            ...
            <textarea name="desc" class="form_name_select2" placeholder="DESCRIPTION">
