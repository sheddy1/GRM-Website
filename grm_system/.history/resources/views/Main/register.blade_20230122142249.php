            ...
            $('#state_select').on('change', function () {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if(res)
                        {
                            $('#lga_select').html('<option value="">LGA</option>');
                    ...
                    success: function(res1){
                        if(res1){
                            $('#form_name_select').html(
                                '<input type="text" name="form_name_select" class="form_name_select" id="form_name_select" value="sdsd">'
                                );
                            $.each(res1, function(key, value){
                                $('#form_name_select').append(
                                '<input type="text" name="form_name_select" class="form_name_select" id="form_name_select" value="'+value.zone1+'">'
                                );
                            });
                        }
                    }
