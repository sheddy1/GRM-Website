...
<body>
    ...
    <footer>
        ...
        <div class="footer_contact">
            ...
            <p class="footer_links_home1 footer_links_home1a"> > Home Page</p>

            <p class="footer_links_about footer_links_home1a"> > About</p>

            <p class="footer_links_reg footer_links_home1a"> > Register Grieviance</p>

            <p class="footer_links_help footer_links_home1a"> > Help</p>

            <p class="footer_links_login footer_links_home1a"> > Staff/Admin Login</p>
        </div>
    </footer>
