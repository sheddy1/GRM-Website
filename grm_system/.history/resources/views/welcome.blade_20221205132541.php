...
<body>
    ...
    <footer>
        ...
        <div class="footer_contact">
            ...
            <p class="footer_contact_desc3 footer_links_home1a"> > Register Grieviance</p>

            <p class="footer_contact_desc4 footer_links_home1a"> > Help</p>

            <p class="footer_contact_desc5 footer_links_home1a"> > Staff/Admin Login</p>
        </div>
    </footer>
