            ...
            <div class="info_category">
                <span class="main_chart1_bar">
                    <span class="main_chart1_bar_header">
                        ...
                        <select class="main_chart1_bar_header_lab_drop" id="main_chart1_bar_header_lab_drop">
                        ...
                        <span class="main_chart1_bar_header_lab_drop_export" id="main_chart1_bar_header_lab_drop_export">
                            <label class="main_chart1_bar_header_lab_drop_export1">
    ...
    $(document).ready(function () {
        ...
        Highcharts.chart('container2', {
            ...
            series: [{
                ...
                innerSize: '70%',
                data: [
                    { name: 'Resolved', y: 20, id: 'sheddy1'},
                    { name: 'Under Review', y: 40, id: 'sheddy2'},
                    { name: 'New cases', y: 40, id: 'sheddy3'},
                ],
                point: {
                    events: {
                        click: function() {
