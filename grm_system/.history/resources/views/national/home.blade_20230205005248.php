    ...
    <div class="main" id="main">
        <div class="main_header">
            ...
            <span class="main_header_desc">
                ...
                <img src="{{ URL('img/notification.png') }}" alt="MAle Icon" class="main_header_desc1_desc_not_icon">

                <img src="{{ URL('img/search1.png') }}" alt="MAle Icon" class="main_header_desc1_desc_search_icon">
            </span>
        </div>
