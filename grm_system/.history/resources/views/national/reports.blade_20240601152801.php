    ...
    <div class="main" id="main">
        ...
        <div class="info">
            ...
            <div class="info_status">
                <span class="main_chart1_oval_header" id="main_chart1_oval_header">
                ...
                <span class="main_chart1_oval_desc" id="main_chart1_oval_desc">
...
<script>
    $(document).ready(function () {
        ...
        $('#main_chart1_oval_header_drop').on('change', function () {
            ...
            var report_summary_month = this.value;
            document.cookie = "report_summary_month = "  + report_summary_month;

            $.ajax({
                url: "{{ route('report_summary_month') }}",
                type: 'get',
                    //data: {search_input:search_input},
                    success: function (res) {
                        if(res)
                        {
                            $('#main_chart1_oval_chart').load(' #main_chart1_oval_chart');
                        }
                    }
            });
        });

        //month change for pie chart
        $('#main_chart1_oval_header_drop1').on('change', function () {
            alert("Nassco");
       ...
       // });
        ...
        Highcharts.chart('container2', {
            ...
            series: [{
                ...
                innerSize: '70%',
                data: [
                    { name: 'Resolved', y: {{ $report_percentage_resolved }}, id: 'sheddy1'},
                    { name: 'Under Review', y: {{ $report_percentage_review }}, id: 'sheddy2'},
                    { name: 'New cases', y: {{ $report_percentage_new }}, id: 'sheddy3'},
                ],
                point:{
                    events:{
                        click: function() {
