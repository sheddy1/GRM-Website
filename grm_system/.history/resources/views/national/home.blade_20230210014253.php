        ...
        <div class="main_chart2">
            ...
            <span class="main_chart2_grieve_state">
                ...
                <span class="main_chart2_grieve_state_map">
                    <span class="main_chart2_grieve_state_map_abia">
                        <img src="{{ URL('img/states/abia.png') }}" alt="" class="main_chart2_grieve_state_map_abia_img">
                        <span class="main_chart2_grieve_state_map_abia_hover">
                            Abia <br> 18
                        </span>
                    </span>

                    <span class="main_chart2_grieve_state_map_adamawa">
                        <img src="{{ URL('img/states/adamawa.png') }}" alt="" class="main_chart2_grieve_state_map_abia_img">
                        <span class="main_chart2_grieve_state_map_abia_hover">
                            Abia <br> 18
                        </span>
                    </span>
