    ...
    <div class="main" id="main">
        ...
        <div class="main_summary">
            ...
            <span class="main_summary_review main_summary1">
                ...
                <img src="{{ URL('img/review1.png') }}" alt="Record Image" class="main_summary_recorded_image2">
            </span>
            ...
            <span class="main_summary_new main_summary1">
                ...
                <img src="{{ URL('img/new.png') }}" alt="Record Image" class="main_summary_recorded_image2">
            </span>
        </div>
