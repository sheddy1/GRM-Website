    ...
    <div class="main" id="main">
        <div class="header">
            ...
            <span class="main_header_desc">
                ...
                <input type="checkbox" id="check_notification">
                <img src="{{ URL('img/notification.png') }}" alt="notification Icon" class="main_header_desc1_desc_not_icon" id="main_header_desc1_desc_not_icon">
        ...
        <div class="main_gro">
            ...
            <div class="main_gro_table1" id="main_gro_table1">
                @php
                    $gro_table = session::get('gro_table')->count();
                    ...
                    $gro_start_code = Session::get('gro_table');
                ...
                <table class="main_gro_table">
                    ...
                    <tr >
                        <td >
                            <tb class="main_gro_table_img">
                                <img src="{{ URL('img/male.png') }}" alt=""
                            </tb>
                            <tb>
                                <td class="main_gro_table_details" style="border-left: 1px solid #8D8D8D;">
                                    @php
                                    $name = session::get('gro_table')->where('id', $i)->value('name1');
                                    $email = session::get('gro_table')->where('id', $i)->value('email');
                                    $title = session::get('gro_table')->where('id', $i)->value('title');
                                    $phone = session::get('gro_table')->where('id', $i)->value('phone');
                                    @endphp
                                    {{ $name }} <br>
                                    {{ $email }} <br>
                                    {{ $title }} <br>
                        ...
                        <td>
                            ...
                            $name = session::get('gro_table')->where('id', $q)->value('name1');
                            $email = session::get('gro_table')->where('id', $q)->value('email');
                            $title = session::get('gro_table')->where('id', $q)->value('title');
                            $phone = session::get('gro_table')->where('id', $q)->value('phone');
                            @endphp
            ...
            @php
                $gro_add_form = session::get('gro_add_form');
            @endphp

            <!-- add pop up -->
            <div class="main_gro_add" id="main_gro_add"
             style="visibility: {{ $gro_add_form }}">
                ...
                method="POST" class="main_gro_add_form" id="main_gro_add_form">
                    @csrf
                    ...
                    <span class="main_gro_add_form_line1_box1">
                        ...
                        <span class="main_gro_add_form_line1_box2">
                            ...
                            <input type="password" name="password" class="main_gro_add_form_line1_box1_input"
                             placeholder ="Enter something easy">
                        ...
                        <span class="main_gro_add_form_line1_box3">
                            ...
                            <input type="text" name="phone" class="main_gro_add_form_line1_box1_input"
                             placeholder ="Enter phone number">
                            <span class="main_gro_error">@error('phone'){{ $message }} @enderror</span>
                        </span>
                    </span>
            ...
            <!-- filter pop up -->
            <div class="main_gro_add main_gro_filter" id="main_gro_filter"
...
<script>
    ...
    //open add code
        const filter_show = document.getElementById("main_gro_header_add");

        const filter_hide = document.getElementById("main_gro_add_main_header_img");

        const filter_box = document.getElementById("main_gro_add");
        ...
        //open filter code
        const filter_show1 = document.getElementById("main_gro_header_filter");

        const filter_hide1 = document.getElementById("main_gro_filter_main_header_img");

        const filter_box1 = document.getElementById("main_gro_filter");

        filter_show1.addEventListener("click", (event) => {
            //alert("Nassco");
            filter_box1.style.visibility = "visible";
        });

        filter_hide1.addEventListener("click", (event) => {
            filter_box1.style.visibility = "hidden";
        });
</script>
