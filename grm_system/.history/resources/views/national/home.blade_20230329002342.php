    ...
    <div class="main" id="main">
        ...
        <div class="main_summary">
            <span class="main_summary_recorded main_summary1">
                <label class="main_summary_recorded_name1">Total Grievances Recorded</label>
            ...
            <span class="main_summary_resolved main_summary1">
                <label class="main_summary_recorded_name2">Total Grievances Resolved</label>
            ...
            <span class="main_summary_review main_summary1">
                <label class="main_summary_recorded_name3">Total Grievances Under Review</label>
            ...
            <span class="main_summary_new main_summary1">
                <label class="main_summary_recorded_name4">Total Grievances Under Review</label>
