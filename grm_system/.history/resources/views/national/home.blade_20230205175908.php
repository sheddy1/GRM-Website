            ...
            <span class="main_chart1_oval">
                ...
                <span class="main_chart1_oval_desc">
                    <span class="main_chart1_oval_desc1">
                            <label main_chart1_oval_desc1_circle></label>
                    </span>

                    <span class="main_chart1_oval_desc2"></span>

                    <span class="main_chart1_oval_desc3"></span>
                </span>

                <span class="main_chart1_oval_chart"></span>
            </span>
